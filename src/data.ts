...
export const projects: Project[] = [
  ...
  { id: '7', title: 'Project Eta', category: '新媒体策划', image: 'https://picsum.photos/seed/p7/800/1422', color: '#808080', description: 'Generative art and machine learning models.' },
  { id: '8', title: 'Project Theta', category: '新媒体策划', image: 'https://picsum.photos/seed/p8/800/1422', color: '#707070', description: 'Experimental web experiences.' },
  { id: '9', title: 'Project Iota', category: '新媒体策划', image: 'https://picsum.photos/seed/p9/800/1422', color: '#E0E0E0', description: 'Visual identity and logo design.' },
  { id: '10', title: 'Project Kappa', category: '新媒体策划', image: 'https://picsum.photos/seed/p10/800/1422', color: '#D5D5D5', description: 'Digital marketing and SEO optimization.' },
  { id: '11', title: 'Project Lambda', category: '新媒体策划', image: 'https://picsum.photos/seed/p11/800/1422', color: '#C0C0C0', description: 'AI-driven copywriting and image synthesis.' },
  { id: '12', title: 'Project Mu', category: '新媒体策划', image: 'https://picsum.photos/seed/p12/800/1422', color: '#B0B0B0', description: 'Interactive installations and physical computing.' },
...
export const categories = ['All', '品牌策划', '新媒体策划', 'AIGC', 'Other'];
