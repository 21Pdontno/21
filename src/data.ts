...
export const projects: Project[] = [
  { 
    ...
    color: '#E0E0E0', 
    description: 'Brand strategy and identity design.',
    detailImages: [
  ...
  { 
    ...
    color: '#D5D5D5', 
    description: 'Social media campaign and content creation.',
    detailImages: [
  ...
  { 
    ...
    color: '#C0C0C0', 
    description: 'AI-generated content and visual exploration.',
    detailImages: [
  ...
  { 
    ...
    color: '#B0B0B0', 
    description: 'Miscellaneous creative experiments.',
    detailImages: [
  ...
  { 
    ...
    color: '#A0A0A0', 
    description: 'Corporate rebranding and positioning.',
    detailImages: [
  ...
  { 
    ...
    color: '#808080', 
    description: 'E-commerce strategy and campaign execution.',
    detailImages: [
  ...
  { 
    ...
    color: '#707070', 
    description: 'Online store optimization and user journey mapping.',
    detailImages: [
  ...
  { 
    ...
    color: '#E0E0E0', 
    description: 'E-commerce platform development and performance marketing.',
    detailImages: [
  ...
  { 
    ...
    color: '#D5D5D5', 
    description: 'Customer acquisition and retention strategies for online retail.',
    detailImages: [
  ...
  { 
    ...
    color: '#C0C0C0', 
    description: 'E-commerce video content and product showcases.',
    detailImages: [
  ...
  { 
    ...
    color: '#B0B0B0', 
    description: 'Building online communities and driving customer loyalty for e-commerce brands.',
    detailImages: [
  ...
  { 
    ...
    color: '#808080', 
    description: 'Automated video generation and editing.',
    detailImages: [
  ...
  { 
    ...
    color: '#B0B0B0', 
    description: 'Virtual reality and augmented reality.',
    detailImages: [
